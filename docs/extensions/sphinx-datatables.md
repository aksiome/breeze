...
Sphinx extension that makes it easy to use more expressive tables with DataTables.

- **Documentation**: [https://sharm294.github.io/sphinx-datatables/](https://sharm294.github.io/sphinx-datatables/)
- **Source Code**: [https://github.com/sharm294/sphinx-datatables/](https://github.com/sharm294/sphinx-datatables/)
